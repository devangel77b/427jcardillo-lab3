...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{2}, 104--107 (2026)} % FOR EDITOR ONLY
...
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{2}, 104--107 (2026)} % FOR EDITOR ONLY
\fancyfoot[C]{\thepage}
...
\begin{document}
\setcounter{page}{104} % FOR EDITOR USE ONLY
...
In our experiment, we utilized a \qty{5.7}{\gram} crying emoji popper toy (``Jumping Gens''; Liberty Imports; Liberty, MO) made of a foam head and nylon body (i.e. coefficient of restitution $COR = \numrange{0.7}{0.95}$)\cite{simeonov:2016:coefficient}. 
...
\end{center}
\caption{Spring force (\unit{\newton}) vs. displacement (\unit{\meter})}
\label{fig:2}
\end{figure}
